...
interface Props {
    ...
    handleKeyDown: (e: React.KeyboardEvent<HTMLInputElement>) => void // Add handleKeyDown to Props
}
...
const AddFriends: React.FC<Props> = ({
    ...
    onSubmit,
    isSubmitting,
    handleKeyDown, // Add handleKeyDown to Props
}) => {
    const {
        setValue,
        watch,
    ...
    return (
        <div className="w-full h-full lg:grid lg:grid-cols-5 lg:min-h-screen relative">
            {isSubmitting && (
